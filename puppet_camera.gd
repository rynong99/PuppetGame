...
func update_position(delta):
	var target_position = puppet.global_transform.origin + Vector3(0, 1.5, 0)
...
func update_camera(delta):
	var xform = camera.global_transform.looking_at(puppet.global_transform.origin, Vector3.UP)
